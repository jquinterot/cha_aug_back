...
def index_test_documents():
    ...
    test_docs = [
        "tests/data/test_rag_document.pdf",  # Original Zyxoria test document
        "tests/data/weird_test_document.pdf"  # Our new weird test document
    ]
    ...
    print("- Zyxoria (from tests/data/test_rag_document.pdf)")
    print("- Quantum Fluffernutter (from tests/data/weird_test_document.pdf)")
    print("- Time-traveling llamas (from tests/data/weird_test_document.pdf)")
